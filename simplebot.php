...
$page_access_token="EAAQj2eBsWk8BAMEWSs7gZBzPHyeGXoZA9o3bxgLD6owmy3G8PJJIZBzVLHc7Ui0cYngFYhK9ncwMMOvLIsdOdZCDZBiA3SyWWii4ZC7vkWtcB7bZCKhWnwSMKETK8yVWbyZBgwJbdrByFblxNRqdyF5cSwDHXNWlxppLZC6EAzX7qIQZDZD";
...
elseif($cmdtext == "send image"){
    sendfile_tofb($senderid, "image", "https://18c4585d.ngrok.io/tutorial/files/sampleimage.png");   
} 
elseif($cmdtext == "send audio"){
    sendfile_tofb($senderid, "audio", "https://18c4585d.ngrok.io/tutorial/files/sampleaudio.mp3");   
} 
...
elseif($cmdtext == "send receipt"){
    sendfile_tofb($senderid, "file", "https://18c4585d.ngrok.io/tutorial/files/samplefile.txt");   
}     
elseif($cmdtext == "name?"){
...
$sendmsg->message->attachment->payload->url = 'https://18c4585d.ngrok.io/tutorial/files/pizza1.jpg';   
$sendmsg->message->quick_replies = $reply;    
...
$elements[] = array("title" => "Awesome Product #1",
                    "image_url" => "https://18c4585d.ngrok.io/tutorial/files/i1.jpg",  'buttons' => $buttons);    
...
$elements[] = array("title" => "Awesome Product #1", "subtitle"=> "It has these great qualities, would be useful!", 
                    "image_url" => "https://18c4585d.ngrok.io/tutorial/files/i1.jpg", "item_url" => "http://google.com/", 'buttons' => $buttons);    
...
$elements[] = array("title" => "Awesome Product #2", "subtitle"=> "It has these great qualities, would be useful!", 
                    "image_url" => "https://18c4585d.ngrok.io/tutorial/files/i2.jpg", "item_url" => "http://google.com/", 'buttons' => $buttons);    
$elements[] = array("title" => "Awesome Product #3", "subtitle"=> "It has these great qualities, would be useful!", 
                    "image_url" => "https://18c4585d.ngrok.io/tutorial/files/i3.jpg", "item_url" => "http://google.com/", 'buttons' => $buttons);    
$elements[] = array("title" => "Awesome Product #4", "subtitle"=> "It has these great qualities, would be useful!", 
                    "image_url" => "https://18c4585d.ngrok.io/tutorial/files/i4.jpg", "item_url" => "http://google.com/", 'buttons' => $buttons);    
